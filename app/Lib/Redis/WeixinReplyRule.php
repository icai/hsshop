...
/**
 * 图文redis类（微信图文与高级图文）
 * @author 吴晓平 <2017.07.27>
 */
class WeixinReplyRule extends RedisInterface
{

    protected $prefixKey = 'weixin_reply_rule';
    ...
    /**
     * [根据主键id获取单条hash数据]
     * @param  integer $id [对应的主键id]
     * @return [type]      [description]
     */
    public function getHashRow($id)
    {
        if ( !$this->redis->exists($this->key.$id)){
            return true;
        }
        return $this->redis->hmget($this->key.$id);
    }
