...
use App\Lib\Redis\EvaluateClassifyRedis;
use App\S\S;
use Hash;
use StaffOperLogService;

class EvaluateClassifyService extends S
{
    /**
     *
    ...
    {
        parent::__construct('EvaluateClassify');
    }
    ...
    {
        $result = [];
        $redis = new EvaluateClassifyRedis();
    ...
    public function update($id,$data){
        ...
        if ($res){
            $storeRedis = new EvaluateClassifyRedis();
