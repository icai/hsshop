...
use App\Lib\Redis\WeixinAdvancedMaterial;
use App\S\S;

class WeixinMaterialAdvancedService extends S{

	public function __construct()
	{
		parent::__construct('WeixinMaterialAdvanced');
	}

	/**
	 * [获取某个店铺下的全部高级图文数据，可以进行分页]
	 * @param  [int]    $wid   [店铺id]
	...
	{
		$wechatRedis = new WeixinAdvancedMaterial();
		$redisData = $mysqlData = [];
        $redisId = [];
