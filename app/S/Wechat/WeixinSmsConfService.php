...
use App\Lib\Redis\WeixinSmsConfRedis;
use App\S\S;

class WeixinSmsConfService extends S
{
    /**
     *
    ...
    {
        parent::__construct('WeixinSmsConf');
    }
    ...
    public function update($id,$data){
        ...
        if ($res){
            $storeRedis = new WeixinSmsConfRedis();
