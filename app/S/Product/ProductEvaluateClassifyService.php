...
use App\Lib\Redis\ProductEvaluateClassifyRedis;
 ...
 * 快递
 */
class ProductEvaluateClassifyService extends S
{
    public function __construct()
    {
        parent::__construct('ProductEvaluateClassify');
    }
    ...
    {
        $result = [];
        $redis = new ProductEvaluateClassifyRedis();
    ...
    public function update($id,$data){
        ...
        if ($res){
            $storeRedis = new ProductEvaluateClassifyRedis();
