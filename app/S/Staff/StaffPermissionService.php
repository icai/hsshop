...
use App\Lib\Redis\StaffPermissionRedis;
use App\S\S;
use Hash;
use StaffOperLogService;

class StaffPermissionService extends S
{
    /**
     *
    ...
    {
        parent::__construct('StaffPermission');
    }
    ...
    {
        $result = [];
        $redis = new StaffPermissionRedis();
    ...
    public function update($id,$data){
        ...
        if ($res){
            $storeRedis = new StaffPermissionRedis();
