...
class AliClientModule {
    //应用ID
    public $appId ='2018071960652473';

    //私钥文件路径
    public $rsaPrivateKeyFilePath;

    //私钥值
    public $rsaPrivateKey ='';
    ...
    //使用读取字符串格式，请只传递该值
    public $alipayrsaPublicKey='';
    ...
    {
        $this->appId = config('app.ali_app_id');
    }
    ...
    */
    ...
    public function execute($request, $authToken = null, $appInfoAuthtoken = null) {
        ...
        if ("json" == $this->format) {
            ...
            \Log::info(json_decode(json_encode($respObject),true));
            if (null !== $respObject) {
                $respWellFormed = true;
