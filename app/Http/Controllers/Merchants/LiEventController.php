...
class LiEventController extends Controller
{
    /*
     * @return void
     */
    ...
    {	
    	...
    	return view('merchants.shareEvent.shareSub.index',[
			'title'      => '享立减',
    ...
    public function save(Request $request)
    {
    	...
    	if ($id) {
    		...
    		if ($shareEventData) {
	            ...
	            if(!empty($shareEventData['lower_price']))
	                $dashareEventDatata['lower_price']=sprintf('%.2f',$shareEventData['lower_price']/100);
    	...
    	return view('merchants.shareEvent.shareSub.save',[
