...
@section('head.css')	
    ...
    <!-- 页面css样式 -->
    <link rel="stylesheet" type="text/css" href="{{ config('app.source_url') }}home/css/extension.css"/>
@endsection
@section('content')
   ...
   <div class="breadcrumb_nav">
       <div>
           ...
           当前位置：<a href="/">首页</a>><span> 推广工具</span>
       </div>
   </div>
   <div class="main">
           ...
           <div class="sideBar">
               ...
               <div class="sideBar_nav">
                   <ul>
                       ...
                       <li class="active"><a href="{{ config('app.url') }}home/index/extension"><span class="icon sideBar_icon5"></span>推广工具</a></li>
                   </ul>
               </div>
           </div>
