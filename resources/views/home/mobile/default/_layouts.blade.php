				...
				<ul class="nav-list ">
					...
					<li class="nav-item">
						...
						<ul class="nav-sub-list none">
							<li class="nav-item">
								<a href="https://ai.huisou.cn">会搜云新零售系统</a>
							</li>
							<li class="nav-item">
							...
							<!-- <li class="nav-item">
								<a href="/home/index/AppDownLoad">会搜云商家版APP</a>
							</li> -->
						</ul>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item">
						...
						<ul class="nav-sub-list none">
							...
							<li class="nav-item">
								<a href="/home/index/4/shop">微商城系统</a>
							</li>
						</ul>
					</li>
					<!-- <li class="nav-item">
						...
						<ul class="nav-sub-list none">
							<li class="nav-item">
								<a href="/home/category/list?type=3">精品APP</a>
							</li>
							<li class="nav-item">
								<a href="/home/category/list?type=2">明星小程序</a>
							</li>
							<li class="nav-item">
								<a href="/home/category/list?type=1">优质微商城</a>
							</li>
						</ul>
					</li> -->
					<li class="nav-item">
...
<script type="text/javascript">
	...
	$(function() {
		...
		$.get("/shop/weixin/getWeixinSecretKey", {
			"url": url
		}, function(data) {
			if (data.errCode == 0) {
				wx.config({
		...
		wx.ready(function() {
			...
			wx.onMenuShareTimeline({
				title: '移动电商，会搜云享-{{ $title or '
				' }}', // 分享标题  
				link: url, // 分享链接,将当前登录用户转为puid,以便于发展下线  
				imgUrl: '{{ config('
				app.source_url ') }}mobile/images/fx-logo.jpg', // 分享图标  
				success: function() {
					// 用户确认分享后执行的回调函数  
					//alert('分享成功');  
				},
