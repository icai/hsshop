...
用心服务于 电商大商家/中大型企业客户…">-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ config('app.source_url') }}mobile/css/helpDetail.css">
</head>
<body> 
	<!-- 顶部 -->
	<div class="header">
    ...
    <div class="detail-content">
        <h1>{{ $inforData['title'] or ''}}</h1>
        <div class="author">
            <span>{{ $inforData['created_at'] }}</span>
            <span>{{ $inforData['author'] or '' }}</span>
        </div>
        <div class="main-cont">
            {!! $inforData['content'] !!}
        </div>
        <div class="question_title">以上内容是否解决了您的问题？</div>
        <div class="botton_btn">
            <button class="btn yes_btn">是的</button>
            <button class="no_btn">没有</button>
        </div>
        
    </div>
    <div class="tip_model">
        <p class="title">请选择未解决的原因</p>
        <form>  
          <div class="reason">
            <div class="mui-checkbox-con">
                <p>
                    <input class="mui-checkbox" type="checkbox" name="reason[]" value="描述不清晰">描述不清晰
                </p>
                <p>
                    <input class="mui-checkbox" type="checkbox" name="reason[]" value="内容不正确">内容不正确
                </p>
            </div>
            <div class="mui-checkbox-con">
                <p>
                    <input class="mui-checkbox" type="checkbox" name="reason[]" value="对产品功能不满意">对产品功能不满意
                </p>
                <p>
                    <input class="mui-checkbox" type="checkbox" name="reason[]" value="操作后未能解决问题">操作后未能解决问题
                </p>
            </div>
        </div>
        <input type="hidden" name="is_solve" value="0">
        <input type="hidden" name="id" value="">
        </form>
        <div class="submit">
            <button class="btn btn_save">提交</button>
        </div>
	</div>
