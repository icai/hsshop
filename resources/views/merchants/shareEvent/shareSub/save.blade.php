        ...
        <div class="game-box">
			...
			<fieldset class="filed-block block1 steps step_1">
                ...
                <div class="control-group clear">
                    ...
                    <div class="controls">
                        <label class="input-append">
                            <input class="form-control wid190" type="text" name="rule_title" placeholder="" value="享立减规则" maxlength="6">
...
<!--当前页面js-->
<script src="{{ config('app.source_url') }}mctsource/js/share_add.js"></script> 
@endsection