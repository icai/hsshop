    ...
    <div class="content"> 
            ...
            <div class="pull-left">
                ...
                <ul class="tab_nav">
                    <li @if(!isset($_GET['type']))class="hover" @endif>
                        <a href="/merchants/share/event/index">所有活动</a>
                    </li>
                    <li @if(isset($_GET['type']) && $_GET['type'] == 0)class="hover" @endif>
                        <a href="/merchants/share/event/index?type=0">进行中</a>
                    </li>
                    <li @if(isset($_GET['type']) && $_GET['type'] == 1)class="hover" @endif>
                        <a href="/merchants/share/event/index?type=1">已结束</a>
                    </li>
                </ul>  
            </div>
        ...
        <div class="mb-15 clearfix pr">
            <div class="widget-list-filter">
            	<div class="pull-left">
                    <a class="btn btn-success " href="{{ URL('/merchants/share/event/save') }}">新建享立减活动</a>
                </div>
        ...
        <div class="main_content">
            ...
            <ul class="data_content">
                ...
                <li class="pr">                    
                    <a class="see_create" href="/merchants/share/event/save?id={{$v['id']}}">编辑</a>
                    @if($v['type']==1)
        ...
        <div class="modal fade" id="setXiang" tabindex="-1" role="dialog"  data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">享立减设置</h4>
                    </div>
                    <div class="modal-body">
...
<!-- 当前页面js -->
<script src="{{ config('app.source_url') }}mctsource/js/share_list2.js"></script> 
@endsection