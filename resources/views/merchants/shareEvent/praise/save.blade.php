...
@section('head_css')
    ...
    <!-- 当前页面css -->
    <link rel="stylesheet" type="text/css" href="{{ config('app.source_url') }}mctsource/css/share_zan_create.css" />
@endsection
@section('slidebar')
    ...
    <div class="middle_header">
        ...
        <div class="third_nav">
            ...
            <ul class="crumb_nav">
                ...
                <li>
                    <a href="javascript:void(0)">集赞二期</a>
                </li>
            </ul>
            <!-- 面包屑导航 结束 -->
        </div>
        ...
        <div class="game-box">
            ...
            <fieldset class="filed-block block1 steps step_1">
                    ...
                    <div class="controls">
                        <label class="input-append">
                            <div class="image-wrap image-warp-active margh10">
                                <div class="js-upload-image add_active_img" data-imgadd="1">+加图</div>
                                <input class="fir-img" type="hidden" name="act_img">
                            </div>
                            <p class="up_tip">建议宽高尺寸：400*400</p>
                        </label>
                    </div>
                </div>
                    ...
                    <div class="controls" style="margin-bottom: 10px;">
                        <div class="picture-list ui-sortable">
                            <ul class="js-picture-list app-image-list clearfix gridly" style="max-width: 300px;">
                                ...
                                <li class="add">
                                    <div class="add-goods js-add-picture">+加图</div>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="control-group clear" style="margin-bottom: 15px;">
                    ...
                    <div class="controls">
                        <input class="form-control z-title" type="text" name="title" placeholder="填写活动名称" value="集赞活动" maxlength="23">
                ...
                <!-- <div class="control-group clear">
                    ...
                    <div class="controls">
                        <div class="input-append">
                            <input type="number" name="Btime" value="1" class="form-control control-error z-wid70 zhujian_price control_block">
                            <span class="">元</span>
                        </div>
                ...
                <div class="control-group clear">
                    <label class="control-label required">集赞人数：</label>
                    <div class="controls">
                        <div class="input-append">
                            <input type="number" name="like_count" value="" class="form-control control-error z-wid70 baodi_price control_block">
                            <span class="">人</span>
                        </div>
                    </div>
                </div>
                <!-- <div class="control-group clear">
                    <label class="control-label required lable_max">助减人数初始值标签：</label>
                    ...
                    <div class="control-group clear initial_value none">
                        <label class="control-label required control-label-min">初始值为：</label>
                        <div class="controls">
                            <label class="input-append">
                ...
                <div class="control-group clear">
                    <label class="control-label required">生成卡片图：</label>
                    <div class="controls">
                        <label class="input-append">
                            <div class="image-wrap image-wrap-card margh10">
                                <div class="image-display z-imga js-upload-image" data-imgadd="5"><i class="icon-add"></i></div>
                                <input class="fir-img" type="hidden" name="card_img">
                            </div>
                            <span class="up_tip">建议宽高尺寸：680*936</span>
                        </label>
                    </div>
                </div>
                <div class="control-group clear">
                    ...
                    <div class="controls">
                        <label class="input-append">
                            <input class="form-control wid190" type="text" name="share_title" placeholder="" value="" maxlength="23">
                ...
                <div class="control-group clear">
                    ...
                    <div class="controls">
                        <label class="input-append">
                            <div class="image-wrap image-wrap-share margh10">
                                <div class="image-display z-imga js-upload-image" data-imgadd="2"><i class="icon-add"></i></div>
                                <input class="fir-img" type="hidden" name="share_img">
                            </div>
                            <span class="up_tip">建议宽高尺寸：420*336</span>
                        </label>
                    </div>
                </div>
                <div class="control-group clear">
                    ...
                    <div class="controls">
                        <label class="input-append">
                            <div class="image-wrap image-wrap-rule margh10">
                                <div class="image-display z-imga js-upload-image" data-imgadd="4" style="background-image: url({{ imgUrl() }}hsshop/image/static/xianglijian_rule.jpg);">
                                </div>
                                <input class="fir-img" type="hidden" name="rule_img" value="/hsshop/image/static/xianglijian_rule.jpg">
                            </div>
                            <span class="up_tip">建议宽高尺寸：750*124</span>
                        </label>
                    </div>
                </div>
                <div class="control-group clear">
                    ...
                    <div class="controls">
                        <label class="input-append">
                            <input class="form-control wid190" type="text" name="rule_title" placeholder="" value="集赞规则" maxlength="6">
                            <span class="up_tip">不超过6个汉字</span>
                        </label>
                    </div>
                </div>
                <div class="control-group clear">
                    <label class="control-label required lable_max">规则弹窗详细内容：</label>
                    <div class="controls">
                        <label class="input-append">
                            <textarea class="form-control wid190" name="rule_text" placeholder="" value=""></textarea>
                            <span class="up_tip">不超过500个汉字</span>
                        </label>
                    </div>
    ...
    <div id="rule_model" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">参与集赞活动的商品，所有用户均可邀请新用户来助减金额<br />
                <br />
1.分享者选择集赞活动商品分享给好友，好友如果是新用户，点击进入小程序，即可帮助分享者减价；<br />
2.每个用户只能助减1次，1次只能助减一款活动商品，即使以后商家多次开启集赞活动，助减过的用户也不能再次帮他人助减<br />
3.活动期间，每单限购一件，如想要再次购买该产品，可再次邀请新用户助减；<br />
4.分享您想购买的活动商品到微信群或微信好友，减至理想价即可下单；<br />
5.每个商品均有保底价及每个新用户可助减的金额，部分集赞商品最低可减至0元；<br />
...
<!--当前页面js-->
<script src="{{ config('app.source_url') }}mctsource/js/share_zan_add.js"></script> 
@endsection