...
<!-- 当前页面css -->
<link rel="stylesheet" type="text/css" href="{{ config('app.source_url') }}mctsource/css/store_6fan8kh1.css" />
@endsection
@section('slidebar')
    ...
    <div class="card">
        <form class="form-horizontal" novalidate="" name="editorForm">
                                ...
                                <div ng-drag="true" ng-drag-data="editor">
                                    ...
                                    <div class="actions">
                                        <div class="actions-wrap">
                                            ...
                                            <span class="action edit" ng-click="addContent($event,$index,editor,20)">加内容</span>
            ...
            <div class="btn_grounp">
                <div class="popover top setting_model_name">
                    <div class="arrow"></div>
                    <div class="popover-inner popover-text">
                        <div class="popover-content">
                            <form class="form-horizontal">
                                <div class="control-group">
                                    <label class="control-label model_name_info">请设置模块名称：</label>
                                    <div class="controls">
                                        <input type="text" class="form-control" ng-model="modelTitle">
                                    </div>
                                </div>
                                <div class="form-actions">
                                    <button type="button" class="btn btn-primary js-btn-confirm" ng-click="save_model_data(editorForm.$valid)">确定</button>
                                    <button type="reset" class="btn js-btn-cancel" ng-click="cancel_model_data(editorForm.$valid)">取消</button>
                                </div>
                            </form>
                        </div>
                    </div>
                </div>
                <button class="btn btn-primary" ng-click="processTemplate(editorForm.$valid)">保存</button>
            </div>
        </form>
    </div>
...
<!-- 当前页面js -->
<script src="{{ config('app.source_url') }}mctsource/js/store_6fan8kh1.js"></script>
@endsection