...
<!-- 当前页面css -->
<link rel="stylesheet" type="text/css" href="{{ config('app.source_url') }}mctsource/css/shop_hksocsf6.css" />
@endsection
@section('slidebar')
...
<div class="middle_header">
    <!-- 二级导航三级标题 开始 -->
    <div class="third_title" id="active_span">
        <span data-id='1' class='active_span'>底部导航</span>
        <span data-id='2'>顶部导航</span>
    </div>
    <!-- 二级导航三级标题 结束 -->
    <!-- 帮助与服务 开始 -->
    <div class="help_btn">
...
<div class="content" ng-app="myApp" ng-controller="myCtrl">
    ...
    <div id='btmNav'>
        <div class="widget-app-board ui-box">
            ...
            <div class="widget-app-board-control">
                <label class="js-switch-bar js-switch ui-switcher pull-right ui-switcher-off" ng-click="isOn($event)"></label>
            </div>
        </div>
        <div class="card">
            <!-- card左侧 -->
                            ...
                            <form class="form-horizontal edit-shopnav" novalidate="">
                                ...
                                <div class="js-nav-region clearfix"  ng-show="menus['menusType']==1">
                                    <ul class="choices ui-sortable edit-shopnav">
                                        <li ng-repeat="menu in menus['menu']" ng-init="outerIndex = $index">
																					<div class="choice">
                                            <div class="first-nav">
                                                <h3>一级导航</h3>
                                                                    ...
                                                                    <div class="dropdown hover" ng-show="!menu['linkUrl']">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            <li class="js_product" role="presentation">
                                                                                <a role="menuitem"  href="javascript:void(0)" ng-click="chooseShop(outerIndex,3)">商品及分类</a>
                                                                            </li>

                                                                            <li class="js_smallPage" role="presentation">
                                                                                <a role="menuitem"  href="javascript:void(0)" ng-click="choosePageLink($index,3)">微页面及分类</a>
                                                                            </li>

                                                                            <li>
                                                                                <a class="js-modal-goods" href="javascript:void(0);" ng-click="chooseActivity($index,3)">营销活动</a>
                                                                            </li>

                                                                            <li class="homepage js_shop" role="presentation">
                                                                                <a role="menuitem"  href="javascript:void(0)" ng-click="chooseLinkUrl($index,menu,1)">店铺主页</a>
                                                                            </li>

                                                                            <li class="homepage js_members" role="presentation" ng-click="chooseLinkUrl($index,menu,2)">
                                                                                <a role="menuitem"  href="javascript:void(0)">会员主页</a>
                                                                            </li>

                                                                            <li class="homepage js_members" role="presentation" ng-click="chooseLinkUrl($index,menu,3)">
                                                                                <a role="menuitem"  href="javascript:void(0)">购物车</a>
                                                                            </li>

                                                                            <li class="homepage js_members" role="presentation" ng-click="chooseLinkUrl($index,menu,4)">
                                                                                <a role="menuitem"  href="javascript:void(0)">拼团</a>
                                                                            </li>
                                                                            ...
                                                                            <!--<li class="homepage js_members" role="presentation" ng-click="chooseLinkUrl($index,menu,5)"><a role="menuitem"  href="javascript:void(0)">联系我们</a></li>-->
                                                                        </ul>
                                                                    </div>
                                                                    <div class="clearfix" ng-show="menu['linkUrl']">
                                                                        ...
                                                                        <div class="dropdown hover pull-right" ng-show="menu.dropDown" ng-cloak>
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                ...
                                                                                <li class="homepage js_members" role="presentation">
                                                                                    <a role="menuitem"  href="javascript:void(0)" ng-click="chooseLinkUrl($index,menu,2)">会员主页</a>
                                                                                </li>
                                            ...
                                            <div class="second-nav" data-first-nav-index="0">
                                                                    ...
                                                                    <div class="pull-left">
                                                                        <div class="dropdown hover" ng-show="!submenu['linkUrl']">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                ...
                                                                                <li class="homepage js_members" role="presentation" ng-click="chooseLinkUrl($index,submenu,5)"><a role="menuitem"  href="javascript:void(0)">联系我们</a></li>
                                                                                <li>
                                                                        ...
                                                                        <div class=" clearfix" ng-show="submenu['linkUrl']">
                                                                            ...
                                                                            <div class="dropdown hover pull-right" ng-show="submenu.dropDown">
                                                                                ...
                                                                                <ul class="dropdown-menu">
                                                                                    ...
                                                                                    <!--<li class="homepage js_members" role="presentation"><a role="menuitem"  href="javascript:void(0)" ng-click="chooseLinkUrl($index,submenu,5)">联系我们</a></li>-->
                                                                                    <li>
                                                ...
                                                <p class="add-shopnav add-second-shopnav js-add-second-nav" ng-click="addSubmenus($index)" ng-show="menu['submenus'].length<5">+ 添加二级导航</p>
                                            </div>
																					</div>
																				</li>
                                    </ul>
                                                    ...
                                                    <div class="control-group control-group-link">
                                                        ...
                                                        <div class="controls">
                                                            <div class="dropdown hover" ng-show="!menu['linkUrl']">
                                                                <a class="dropdown-toggle js-link-to" href="javascript:void(0);">选择链接页面</a>
                                                                <ul class="dropdown-menu">
                                                                    <li class="js_product" role="presentation"  ng-click="chooseShop(outerIndex,3)">
                                                                        <a role="menuitem"  href="javascript:void(0)">商品及分类</a>
                                                                    </li>

                                                                    <li class="js_smallPage" role="presentation" ng-click="choosePageLink($index,3)">
                                                                        <a role="menuitem"  href="javascript:void(0)">微页面及分类</a>
                                                                    </li>
                                                                    ...
                                                                    <li class="homepage js_shop" role="presentation" ng-click="chooseLinkUrl($index,menu,1)">
                                                                        <a role="menuitem"  href="javascript:void(0)">店铺主页</a>
                                                                    </li>
                                                                    ...
                                                                    <li class="homepage js_shop" role="presentation" ng-click="chooseLinkUrl($index,menu,4)">
                                                                        <a role="menuitem"  href="javascript:void(0)">拼团</a>
                                                                    </li>
                                                                    <!--<li class="homepage js_members" role="presentation" ng-click="chooseLinkUrl($index,menu,5)"><a role="menuitem"  href="javascript:void(0)">联系我们</a></li>-->
                                ...
                                <p class="add-shopnav js-add-nav" ng-click="addmenus()" ng-show="menus['menu'].length < 4">+ 添加一级导航</p>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <div id='topNav' style='display: none'>
        <div class="widget-app-board ui-box">
            ...
            <div class="widget-app-board-control">
                <label data-id='1' :class="{is_used_nav == 1 ? 'ui-switcher-on' : 'ui-switcher-off'}" class="js-switch_nav js-switch ui-switcher pull-right swich_onoff" ng-click="isOnNav($event)"></label>
            </div>
        </div>
        <div class="card">
            <!-- card左侧 -->
            <div class="show">
                <div class="wrapper card_left" style='margin-bottom: 0'>
                    <div class="left_content">
                        <h1>
                            <span></span>
                        </h1>
                    </div>
                    <div class="bottom" ng-cloak style="background:@{{colorSeting.background_font_color}}">
                        <div class="item" ng-repeat="item in tabBarList">
                            <div class="navauto">
                                <p class="title" ng-class="{'active_t':$index == 0}" ng-if="$index == 0" style="color:@{{colorSeting.checked_font_color}};border-bottom:2px solid @{{colorSeting.checked_font_color}}">@{{item.title}}</p>
                                <p class="title" ng-if="$index != 0" style="color:@{{colorSeting.font_color}}">@{{item.title}}</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card_right"  ng-cloak style='margin-top: 0'>
                <div class="arrow"></div>
                <div class="editer-content">
                    <div class="control-group" style='padding-top: 0'>
                        <div>
                            <form class="form-horizontal edit-shopnav" novalidate="">
                                <div class="edit">
                                    <div class="nav-color-set">
                                        <div class="nav-back-color">
                                            <label class="control-label res_time page_bg_color">背景图颜色设置：</label>
                                            <div class="controls page_title res_time">
                                                <input type="color" name="color" class="form-control" ng-model="colorSeting.background_font_color">
                                            </div>
                                        </div>
                                        <div class="nav-font-color-checked">
                                            <label class="control-label res_time ">导航字选中颜色设置：</label>
                                            <div class="controls page_title res_time">
                                                <input type="color" name="color" class="form-control" ng-model="colorSeting.checked_font_color">
                                                
                                            </div>
                                        </div>
                                        <div class="nav-font-color-not-checked">
                                            <label class="control-label res_time ">导航字未选中颜色设置：</label>
                                            <div class="controls page_title res_time">
                                                <input type="color" name="color" class="form-control" ng-model="colorSeting.font_color">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="item-wrapper" ng-repeat="item in tabBarList">
                                            ...
                                            <div class="item">
                                                ...
                                                <div class="control-group mb-20">
                                                    ...
                                                    <p class="help-block error-message" style='padding-left: 100px' ng-show="!item.title">名称不能为空</p>
                                                </div>
                                                <!-- 链接 -->
                                                <div class="control-group mb-20">
                                                    <label class="control-label"><em class="required">*</em>链接：</label>
                                                    <div class="wrapper wrapper_item">
                                                    ...
                                                    <p class="help-block error-message" style='padding-left: 100px' ng-show="!item.urlTitle">链接不能为空</p>
                                                </div>
                                            </div>
                                            <!-- 导航设置结束 -->
                                        </div>
    ...
    <!-- 微页面弹框开始 -->
    <div class="modal export-modal" id="page_model_nav">
        <div class="modal-dialog" id="page-dialog">
            <form class="form-horizontal">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <table class="table table-striped ui-table ui-table-list">
                            ...
                            <tr>
                                ...
                                <th class="opts">
                                    <div class="td-cont">
                                        <form class="form-search">
                                            <div class="input-append">
                                                <input class="input-small js-modal-search-input form-control" type="text" ng-model="pageData.searchTitle"><a href="javascript:void(0);" class="btn js-fetch-page js-modal-search" ng-click="searchPageNav()">搜</a>
                                            </div>
                                        </form>
                                    </div>
                                </th>
                            ...
                            <tr ng-repeat = "list in pageData.list">
                                ...
                                <td>
                                    <div class="td-cont text-right">
                                        <span class="btn js-choose choose_btn_@{{$index}}" href="javascript:void(0);" ng-click="choosePageLinkSureNav(list)">选取</span>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div class="modal-footer clearfix">
                        ...
                        <div class="page_pagenavi" id='page_nav'></div>
                    </div>
                </div>
            </form>
        </div>
