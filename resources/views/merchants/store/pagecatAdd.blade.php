...
<!-- 当前页面css -->
<link rel="stylesheet" type="text/css" href="{{ config('app.source_url') }}mctsource/css/store_e8ww7p9c.css" />
@endsection
@section('slidebar')
...
<div class="middle_header">
 ...
 <div class="third_nav">
  ...
  <ul class="crumb_nav">
    <li>
       <a href="#&status=1">页面分类</a>
    </li>
    <li>
     <a href="#&status=2">{{$page_title}}</a>
   </li>
   </ul>
   <!-- 面包屑导航 结束 -->
   </div>   
...
<div class="content" ng-app="myApp" ng-controller="myCtrl">
    <input id="wid" type="hidden" value="{{$wid}}" />
        <!-- <div class="alert fade in">
            ...
            <strong>提示：</strong>在浏览器中发现未提交的内容，是否使用该内容替换当前内容？
            <a class="js-use-storage" href="javascript:;">使用</a>
        </div> -->
    <div class="card" ng-cloak>
        <form name="editorForm" novalidate="" class="form-horizontal">
            <div class="card_left">
                    ...
                    <div class="js-fields-region">
                        <div class="app-fields ui-sortable">
                            <div class="app-field clearfix @{{editor['editing']}}" data-type="@{{editor['type']}}" ng-repeat = 'editor in editors' style="background:@{{editor['bgcolor']}}" ng-click="tool($event,editor)" ng-mouseover="addboder($event)" ng-mouseout="removeboder($event,editor)" ng-drop="true" ng-drop-success="onDropPageComplete($index, $data,$event)">
                                <!-- 新建微页面模板 -->
                                <category ng-show="editor['type'] == 'category'"></category>
                                <div ng-drag="true" ng-drag-data="editor">
                                    ...
                                    <div class="actions" ng-show="$index">
                        ...
                        <div class="app-add-field">
                            ...
                            <ul>
                                ...
                                <li ng-click="addShop(1)">
                                    <a class="js-new-field" data-field-type="store">进入
                                        <br>店铺</a>
                                </li>
                                <li>
            ...
            <div class="card_right card_right_list" ng-show="editors[index]['showRight']">
                ...
                <div ng-show="!editors[index]['is_add_content']">
                    ...
                    <!-- 新建微页面导航右侧 -->
                    <crcategory ng-show="editors[index]['cardRight'] == 2"></crcategory>
                    <!-- 富文本编辑器右侧 -->
            ...
            <div class="btn_grounp">
                <button class="btn btn-primary" ng-click="processPageType(editorForm.$valid)">保存</button>
            </div>
        </form>
    </div>
    <!-- 添加微页面Model -->
    <div class="modal export-modal" id="page_current_model">
        <div class="modal-dialog" id="page_current_dialog">
                                ...
                                <tr ng-repeat = "list in pageList">
                                    ...
                                    <td>
                                        <div class="td-cont text-right">
                                            <button class="btn js-choose choose_btn_@{{$index}}" href="javascript:void(0);" ng-click="choosePage($index,list)">选取</button> 
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                                ...
                                <tr>
                                    ...
                                    <th class="opts" class="col-sm-4 col-xs-4">
                                        <div class="td-cont">
                                            <form class="form-search">
                                                <div class="input-append">
                                                    <input class="input-small js-modal-search-input form-control" type="text"
                                                    ng-model="searchTitle">
                                                    <a href="javascript:void(0);" class="btn js-fetch-page js-modal-search" ng-click="searchCoupon()">搜</a>
                                                </div>
                                            </form>
                                        </div>
                                    </th>
                    ...
                    <div class="modal-footer clearfix">
                        ...
                        <div class="text-center">
                           <!--  <button class="ui-btn js-confirm ui-btn-disabled" disabled="disabled" ng-show="!chooseSureBtn">确认</button> -->
                            <button class="ui-btn js-confirm ui-btn-primary" ng-click="chooseAdvSureBtn()">确认</button>
                        </div>
                    </div>
                </div>
            </form>
...
@section('page_js')
    ...
    var imgUrl = "{{ imgUrl() }}";
    var type_template={!! $type_template !!}
    var store={!! $store !!};
    ...
    <!-- 当前页面js -->
    <script src="{{ config('app.source_url') }}mctsource/js/store_e8ww7p9c.js"></script>
@endsection