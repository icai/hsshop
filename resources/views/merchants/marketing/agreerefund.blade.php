...
<div class="content">
    ...
    <div class="common_top mgb15">
        ...
        <p class="common_title">商家同意退款提醒设置</p>
    ...
    <form class="form-horizontal" method="post" action="">
        ...
        <label class="col-sm-2 control-label">商家同意退款提醒：</label>
            <div class="col-sm-10">
                <!-- 按钮 开始 -->
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 clearfix">
                <span class="pull-left">买家下单</span>
                <div class="col-sm-2">
            ...
            <div class="col-sm-10">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="mg15">嗨！您要购买的“<商品名称>”还没付款哦。查看详情 <订单链接></div>
                    </div>
                </div>
                <!-- 面板1 结束 -->
                <!-- 面板2 开始 -->
