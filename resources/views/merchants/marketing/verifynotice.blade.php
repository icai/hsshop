   ...
   <div class="content">
        ...
        <form class="form-horizontal" method="post" action="">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">核销提醒：</label>
                <div class="col-sm-10">
                    <!-- 按钮 开始 -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab_body mg15">
                                <div class="tab0 tab_items">使用成功通知，您在<店铺名称>购买的<商品名称>商品已使用1张，剩余X-1张。查看详情 <订单链接>
                                </div>
                                <div  class="tab1 tab_items no">使用成功通知，您在<店铺名称>购买的<商品名称>商品已使用1张，剩余X-1张。查看详情 <订单链接></div>        
                            </div>
                        </div>
                    </div>
                    <!-- 面板1 结束 -->
