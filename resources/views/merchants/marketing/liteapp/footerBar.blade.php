        ...
        <form ng-app="myApp" ng-controller="myCtrl" name="editorForm" ng-click="navSelectHide()">
            ...
            <div class="app">
            	<div class="appInfo">
            		...
            		每次更改导航配置需重新提交微信审核，审核通过后才可生效
            	</div>
                <div class="appInfo" ng-cloak ng-if="xcx_status && xcx_status != 2">
                    <i class="icon-info glyphicon glyphicon-info-sign"></i>
                    如只修改名称或图片，则无需提交审核，<a href="/merchants/marketing/footerSyncBar">请点击 》》</a>   
                </div>
            	<div class="app-content clearfix" ng-cloak>
            		...
            		<div class="edit">
    					...
    					<div class="navigation">
                            <!-- 导航模块开始  updata by 邓钊 2018-8-20 -->
    						<div class="item-wrapper dropBox" data-id='@{{$index}}' ng-repeat="item in tabBarList" on-finish-render-filters>
    							<div class="label vertical-top fz-12">导航@{{$index + 1}}：</div>
                                <!-- 导航设置开始 updata by 邓钊 2018-8-20 -->
    							<div class="item dragBox" data-id='@{{$index}}' draggable='true'>
                                    <div class="delete" ng-click="deleteNavBar(item,$index)" ng-if="$index != 0">x</div>
                                    <!-- 名称 -->
                                    ...
                                    <div class="control-group mb-20">
                                        ...
                                        <div class="wrapper" ng-show="item.pagePath || item.pageId > 0">
                                            ...
                                            <div ng-if="item.urlTitle">
                                                ...
                                                <span class="co-38f fz-12" ng-if="item.isCanReviseUrl" ng-click="showSelect($index)">修改</span>
                                            </div>
                                        </div>
                                        <div class="wrapper" ng-show="!item.pagePath && item.pageId == 0">
                            ...
                            <div class="add-nav">
                                ...
                                <div ng-click="addNav(7)" ng-if="tabBarList.length < 5">+添加导航</div>
                            </div>
    					</div>
            		</div>
            	</div>
...
<script src="{{ config('app.source_url') }}mctsource/js/footerBar.js" type="text/javascript" charset="utf-8"></script>
