    ...
    <div class="middle_header">
        ...
        <div class="third_nav">
            ...
            <ul class="crumb_nav">
                ...
                <li>
                    <a href="javascript:void(0)">调查留言</a>
                </li>
            </ul>
            <!-- 面包屑导航 结束 -->
        </div>
...
@section('content')
    ...
    <div class="content" ng-app="myApp" ng-controller="myCtrl" ng-cloak>
        ...
        <!-- end -->
        <!--add by 邓钊 2018-6-27-->
        <!-- <ul class='type_ul clear' ng-if="page_template=='' || page_template ==null">
            <li ng-class="{'li_active' : type == 0}" ng-if="type==0">留言编辑</li>
            <li ng-class="{'li_active' : type == 1}" ng-click='cutType(1)'>预约编辑</li>
            <li ng-class="{'li_active' : type == 2}" ng-click='cutType(2)' class='last_li'>投票编辑</li>
        </ul> -->
        <!--end-->
        <!-- card开始 -->
        <div class="card">
            <div class="card_left">
                ...
                <div class="btn-box" style="background:@{{pageSeting.background_color}}">
                    <button class="submit-btn" ng-bind="pageSeting.submit_button_title" style="background:@{{pageSeting.submit_button_color}};color:#fff;border:0" disabled></button>
                </div>
                <!-- 底部自定义导航 -->
                    ...
                    <div class="editor-content">
                        <div class="control-group">
                            ...
                            <div class="controls page_title res_time">
                                <input class="form-control w240 iblock valid" type="text" id="startTime" value='' ng-model='pageSeting.start_at'>
                                至
                                <input class="form-control w240 iblock valid" type="text" id="endTime" value='' ng-model='pageSeting.end_at'>
                            </div>
                            <label class="control-label res_time">
...
@section('page_js')
    ...
    <script>
        ...
        // $.ajax({
        //     url:'/merchants/marketing/researchEdit',
        //     data:{
        //         "id":"17"
        //     },
    ...
    <script src="{{ config('app.source_url') }}mctsource/js/res_z12g34jg.js"></script>
@endsection