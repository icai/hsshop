                                        ...
                                        <div class="position-wrap">
                                            <div class="wechat-template-preview">
                                                <div class="wechat-template-content">
                                                    ...
                                                    <div class="wechat-template-title">待处理订单通知</div>
                                                    <div class="wechat-template-date">10月11日</div>
                                                    <div class="wechat-template-html">你好,“{{ request()->session()->get('shop_name') }}”管理员，你店铺有新的客服消息咨询尚未处理
                                                        <br>编号：XXXXX
                                                        <br>备注：请您看到消息后登录商家后台及时回复处理
                                                        <br>感谢您对会搜云的支持
                                                    </div>
