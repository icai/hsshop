...
<!-- 当前页面css -->
<link rel="stylesheet" type="text/css" href="{{config('app.source_url')}}mctsource/css/wechat_np09ubsm.css"> 
...
<div class="content" style="display: -webkit-box;">
					...
					<div class="app_left">
						...
						<div class="left_content">
							<div class="cover" data-id="{{ $detail['id'] or 0 }}">
								<h4 class="title">{{ $detail['title'] or '标题' }}</h4>
					...
					<div class="app_right">
						<form role="form">
							<div class="form-group">
								...
								<div class="dropdown"style="position: relative;display: flex;">
									...
									<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
								    	...
								    	<!-- <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:void(0)" data-toggle="modal" data-target="#myModal">营销活动</a></li> -->
							...
							<div class="form-group">
								...
								<textarea class="digest" name="digest" maxlength="120" rows="3" cols="48">{{ $detail['digest'] or '' }}</textarea>
							</div>
						</form>
					</div>
				</div>               				
	                    ...
	                    <div class="modal-body">
	                        ...
	                        <div class="attachment-list-region">
	                        	...
	                        	<div class="imgData">
	                                ...
	                                <a href="##" class="ui-btn ui-btn-success js-show-upload-view" style="position: absolute; left: 195px; bottom: 20px;">上传图片</a>
	                            </div>
	...
	<script src="{{config('app.source_url')}}mctsource/js/wechat_np09ubsm.js"></script>
