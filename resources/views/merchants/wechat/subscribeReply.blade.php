...
<!-- 当前页面css -->
<link rel="stylesheet" type="text/css" href="{{config('app.source_url')}}mctsource/css/wechat_uzvx7g2k.css">
@endsection
                ...
                <div class="rule_body clearfix">
                    ...
                    <div class="rule_left">
                        <div style="display: none;">
                            ...
                            <div class="rule_add_keywords">
                                <a class="co_38f js_ad" style="display: none;" href="javascript:void(0)" data-rule_id="{{ $v['id'] }}">
                                    +添加关键词
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="rule_right" data-rule_id="{{ $v['id'] }}">
                        ...
                        <div class="rule_add_reply">
                            <a class="co_38f" href="javascript:void(0)">设置回复</a>
                        </div>
                        <!--规则右边结束-->
                    </div>
                </div>
...
<!-- 当前页面js -->
<script src="{{config('app.source_url')}}mctsource/js/wechat_uzvx7g2k.js"></script>
@endsection