...
<!-- 当前页面css -->
<link rel="stylesheet" type="text/css" href="{{config('app.source_url')}}mctsource/css/wechat_sj792tfy.css">
...
<div class="content" style="display: -webkit-box;">
					...
					<div class="app_left">
						...
						<div class="left_content">
							<div class="cover list" data-id="{{ $detail['id'] or 0}}">
								...
								<!--用于保存ueditor的内容-->
								<div class="cover_author" style="display: none;">{{ $detail['author'] or '' }}</div>
								<div class="cover_editor" style="display: none;">{{ $detail['content'] or '' }}</div>
								<!-- 用于保存封面显示正文的值  0为 false 1 为 true-->
								<input type="hidden" class="cover_checked" @if(isset($detail['show_cover_pic']) && $detail['show_cover_pic'] == 1) value="1" @else value="0" @endif>
								<!-- 用于保存外链 -->
								<a class="cover_href" href="{{ $detail['content_source_url'] or '#'}}" style="display: none;">{{ $detail['content_source_title'] or ''}}</a>
								<div class="opts">
							...
							<div class="cover_list list" data-id="{{ $v['id'] }}">
								...
								<div class="cover_author" style="display: none;">{{ $v['author'] or '' }}</div>
								<div class="cover_editor" style="display: none;">{!! $v['content'] or '' !!}</div>
								<!-- 用于保存封面显示正文的值  0为 false 1 为 true-->
								<input type="hidden" class="cover_checked" @if($v['show_cover_pic'] == 1) value="1" @else value="0" @endif>
								<!-- 用于保存外链 -->
								<a class="cover_href" href="{{ $v['content_source_url'] }}" style="display: none;">{{ $v['content_source_title'] }}</a>
								<div class="opts">
									<span class="editor">编辑</span>
									@if($k > 0)
							...
							<div class="left_bottom">
								<a class="co_38f" href="javascript:void(0);">+新增</a>
							</div>
						</div>
					</div>
					<div class="app_right">
								...
								<div class="dropup" style="position: relative;">
									...
									<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
										<li class="js_smallPage" role="presentation">
											<a role="menuitem" tabindex="-1" href="javascript:void(0);">微页面及分类</a>
										</li>
										<li class="js_product" role="presentation">
											<a role="menuitem" tabindex="-1" href="javascript:void(0);">商品及分类</a>
										</li>
										<!-- <li role="presentation">
											<a role="menuitem" tabindex="-1" href="javascript:void(0);" data-toggle="modal" data-target="#myModal">营销活动</a>
										</li> -->
										<!-- <li role="presentation">
											<a role="menuitem" tabindex="-1" href="javascript:void(0);" data-toggle="modal" data-target="#myModal3">投票调查</a>
										</li> -->
										<li class="js_shop homepage" role="presentation" class="link_to">
											<a role="menuitem" tabindex="-1" href="javascript:void(0);">店铺主页</a>
										</li>
										<li class="js_members homepage" role="presentation" class="link_to">
											<a role="menuitem" tabindex="-1" href="javascript:void(0);">会员主页</a>
										</li>
										<!-- <li role="presentation" class="custom">
											<a role="menuitem" tabindex="-1" href="javascript:void(0);">自定义外链</a>
										</li> -->
									</ul>
								</div>
							</div>
	                    ...
	                    <div class="modal-body">
	                        ...
	                        <div class="attachment-list-region">
	                        	...
	                        	<div class="imgData">
	                                ...
	                                <a href="javascript:void(0);" class="ui-btn ui-btn-success js-show-upload-view" style="position: absolute; left: 195px; bottom: 20px;">上传图片</a>
	                            </div>
	...
	<script type="text/javascript">
		...
		var ueditorContent = '{!! $detail['content']??""!!}';	
		var imgUrl = "{{ imgUrl() }}";
	</script>
	<!--ueditor插件-->
	...
	<script src="{{config('app.source_url')}}mctsource/js/wechat_sj792tfy.js"></script>
