...
return [
     ...
     */
    'app_id'  => env('PUBLIC_APP_ID', 'wxee7d88b92abea67d'),         // AppID
    'secret'  => env('PUBLIC_SECRET', '6f3219e8528a92935e89ffb2b1759356'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', '61F6C8_D'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', ''),                    // EncodingAESKey
    'payee' => env('WECHAT_PAYEE', '会搜科技有限公司'),                    //支付信息显示
    'mch_id' => env('WECHAT_MCH_ID', ''),                         //商户号
    'mch_key' => env('WECHAT_MCH_KEY', ''),                  //商户秘钥

    /**
     * 是否开启代销
     */
    'is_open_deposit' => false,
    ...
    // ],
    //微信扫码支付配置信息 盈搜科技公众号账户信息
    'native_app_id'=>env('native_app_id',"wx54b4f708dbdcb210"),
    'native_mch_id'=>env('native_mch_id','1265877401'),
    'native_pay_key'=>env('native_pay_key','huisou123huisou321yingsou3211353'),
];
