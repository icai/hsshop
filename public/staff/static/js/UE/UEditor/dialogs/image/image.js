...
(function () {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            console.log(editor.getOpt('upCDNUrl'));
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.code == '200') {
                        ...
                        postData['path'] = json.url;
                        postData['type'] = file.type;
                        postData['size'] = file.size;
                        postData['img_size'] = json['image-width'] + 'x' + json['image-height'];
                        postData['classifyId'] = 0;
                        $.get('/merchants/myfile/setFile',postData).then(function(data){ 
                        })
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                if(data.url != undefined){
                    var pre_url = editor.getOpt('imgUrl') + data.url.substr(1,data.url.length - 1);
                }else{
                    var pre_url = '';
                }
                list.push({
    ...
    OnlineImage.prototype = {
        ...
        getImageData: function () {
            ...
            if(!_this.listEnd && !this.isLoadingData) {
                ...
                var url = '/merchants/myfile/getImgList',
