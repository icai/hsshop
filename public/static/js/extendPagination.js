        ...
        if (totalPage > 0) {
            ...
            if (totalPage <= showPage) {
                for (var i = 1; i <= totalPage; i++) {
                    if (i == 1) html.push(' <li class="active" ng-click="goPage('+i+')"><a href="javascript:void(0);" data-page="'+i+'">' + i + '</a></li>');
                    else html.push(' <li ng-click="goPage('+i+')"><a href="javascript:void(0);" data-page="'+i+'">' + i + '</a></li>');
                }
            } else {
                for (var j = 1; j <= showPage; j++) {
                    if (j == 1) html.push(' <li class="active" ng-click="goPage('+j+')"><a href="javascript:void(0);" data-page="'+j+'">' + j + '</a></li>');
                    else html.push(' <li ng-click="goPage('+j+')"><a href="javascript:void(0);" data-page="'+j+'">' + j + '</a></li>');
                }
            }
            html.push('<li class="disabled hidden"><a href="javascript:void(0);">...</a></li>');
