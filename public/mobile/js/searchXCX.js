...
tool.hitEgg = function(obj){
    ...
    html += '<div class="c_model" id="suc_register" style="background:#fff;padding: 8px;overflow: hidden; position: fixed; z-index: 1000; transition: opacity 300ms ease; top: calc(50% - 40px); left: 50%; transform: translate3d(-50%, -50%, 0px); visibility: visible; border-radius: 4px; background: white; width: 270px;opacity: 1;padding-bottom: 30px;">'
	...
	html += '</div>'
	html += '<p class="content_info">小程序：<span class="ff49">'+obj.content+'</span>可以使用!</p>'
	html += '<div class="button_group">'
	html += '<a class="register" href="/home/index/serviceThi">立即注册，抢占先机！</a>'
