    ...
    created: function() {
        ...
        var dataTop = ruleData;
            ...
            this.chatUrl = CHAT_URL + '/zfb/kefu?productName=' + encodeURIComponent(dataTop.product.title) + '&productImg=' + APP_IMG_URL + dataTop.product.img +
                           '&productPrice=' + dataTop.product.price + '&productLink='+ APP_HOST +'/shop/grouppurchase/detail/' + dataTop.id + '/' + dataTop.wid +
            ...
            var urle = "/shop/groups/getPreViewDetailEvaluate/" + this.list1.pid;
            this.show = 'show'
        ...
        var url2 = "/shop/groups/getPreViewGroups/" + rule_id
        ...
        var url3 = "/shop/groups/preViewRecommendGroups"
