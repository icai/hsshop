	...
	qq.maps.event.addListener(map, 'click', function(event) {
    	...
    	geocoder = new qq.maps.Geocoder({
	        complete : function(result){
		        ...
		        $('.search_map').attr('data-lat',event.latLng.getLat())
				$('.search_map').attr('data-lng',event.latLng.getLng())
...
function addAddress(that){
    ...
    $('.search_map').attr('data-lat',$(that).data("lat"))
	$('.search_map').attr('data-lng',$(that).data("lng"))
