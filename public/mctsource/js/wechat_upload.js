	        ...
	        function setState( val ) {
	            ...
	            switch ( state ) {
	                ...
	                case 'finish':
	                    stats = uploader.getStats();
	                    if ( stats.successNum ) {
	      //                   pictureSrc = $('.imgWrap img').attr('src');
	        ...
	        uploader.on('uploadSuccess',function (file,response) {//上传成功后接收数据
				...
				pictureSrc = '/'+response.data.FileInfo.path;
				pictureSize = response.data.FileInfo.img_size
				$('.content_second .modal-footer .js-confirm').hide();
				$('.modal-footer .ui-btn-primary').removeClass('no');
	        })
