...
app.directive('crGoods',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxcrgoods.html',
        link:function(scope,ele,attr){
        }
    }
})
...
app.directive('advs',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxadvs.html',
        link:function(scope,ele,attr){
        }
    }
})
...
app.directive('cradvs',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxcradvs.html',
        link:function(scope,ele,attr){
        }
    }
})
...
app.directive('crtitle',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxcrtitle.html',
        link:function(scope,ele,attr){
        }
    }
})
...
app.directive('crgoodslist',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxcrgoodslist.html',
        link:function(scope,ele,attr){
        }
    }
})
...
app.directive('goodgroup',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxgoodgroup.html',
        link:function(scope,ele,attr){
        }
    }
})
...
app.directive('crgoodgroup',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxcrgoodgroup.html',
        link:function(scope,ele,attr){
        }
    }
})
...
app.directive('crvideo',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxcrvideo.html',
        link:function(scope,ele,attr){
        }
    }
})
...
//享立减二期
app.directive('ligoods',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/liGoods.html',
        link:function(scope,ele,attr){
        }
    }
})

app.directive('crligoods',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/crliGoods.html',
        link:function(scope,ele,attr){
        }
    }
})
...
app.directive('crgroupTemplate',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxcrgroupTemplate.html',
        link:function(scope,ele,attr){
        }
    }
})
app.directive('groupTemplate',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxgroupTemplate.html',
        link:function(scope,ele,attr){
        }
    }
})
 ...
 * @description: 直播组件
 * @return {}
 * @Date: 2020-03-10 20:50:37
 */
app.directive('crlive',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxcrliveTemplate.html',
        link:function(scope,ele,attr){
        }
    }
})
app.directive('live',function($compile){
    return{
        restrict:'AE',
        scope:true,
        templateUrl: HOST + 'mctsource/template/xcxliveTemplate.html',
        link:function(scope,ele,attr){
        }
    }
})
